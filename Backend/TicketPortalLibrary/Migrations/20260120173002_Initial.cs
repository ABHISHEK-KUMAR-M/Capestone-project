    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DepartmentId = table.Column<string>(type: "varchar(5)", nullable: false),
                    DepartmentName = table.Column<string>(type: "varchar(25)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SlaId = table.Column<string>(type: "varchar(5)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmpId = table.Column<string>(type: "varchar(5)", nullable: false),
                    Name = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
                    Email = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Password = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Role = table.Column<string>(type: "varchar(20)", nullable: false),
                    DepartmentId = table.Column<string>(type: "varchar(5)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketTypeId = table.Column<string>(type: "varchar(5)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketTypeId = table.Column<string>(type: "varchar(5)", nullable: false),
                    CreatedByEmpId = table.Column<string>(type: "varchar(5)", nullable: false),
                    AssignedToEmpId = table.Column<string>(type: "varchar(5)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReplyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketId = table.Column<int>(type: "int", nullable: false),
                    RepliedByCreatorEmpId = table.Column<string>(type: "varchar(5)", nullable: false),
                    RepliedByAssignedEmpId = table.Column<string>(type: "varchar(5)", nullable: true),
                    Message = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false),
                    EmployeeEmpId = table.Column<string>(type: "varchar(5)", nullable: true),
                    EmployeeEmpId1 = table.Column<string>(type: "varchar(5)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketReply", x => x.ReplyId);
                    table.ForeignKey(
                        name: "FK_TicketReply_Employee_EmployeeEmpId",
                        column: x => x.EmployeeEmpId,
                        principalTable: "Employee",
                        principalColumn: "EmpId");
                    table.ForeignKey(
                        name: "FK_TicketReply_Employee_EmployeeEmpId1",
                        column: x => x.EmployeeEmpId1,
                        principalTable: "Employee",
                        principalColumn: "EmpId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketReply_EmployeeEmpId",
                table: "TicketReply",
                column: "EmployeeEmpId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketReply_EmployeeEmpId1",
                table: "TicketReply",
                column: "EmployeeEmpId1");
